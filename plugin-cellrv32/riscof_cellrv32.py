...
class cellrv32(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","cellrv32")
    ...
    def initialise(self, suite, work_dir, archtest_env):
       ...
       execute = 'sh ./sim/questa_setup.sh'
...
#The following template only uses shell commands to compile and run the tests.
    ...
    def runTests(self, testList):
      ...
      for testname in testList:
          ...
          # cellrv32-specific - dirrrty shell stuff! ;)
